...
export function createSocketClient() {
    ...
    if (typeof window !== 'undefined') {
        ...
        if (envUrl && !envUrl.includes('localhost') && !envUrl.includes('127.0.0.1')) {
            ...
            socketUrl = envUrl;
            log.info('Using VITE_SOCKET_URL:', socketUrl);
        } else {
        ...
        // NOTE: Vite apps runs on browser, this is fallback for potential SSG or non-browser env
        socketUrl = "http://stream-socket:3001";
