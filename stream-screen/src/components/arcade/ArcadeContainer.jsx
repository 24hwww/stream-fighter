...
export default function ArcadeContainer() {
    ...
    const checkWinner = useCallback((state, currentPoll) => {
        ...
        setWinner(prevWinner => {
            if (prevWinner) return prevWinner; // Don't override existing winner
            if (state.fighterA.hp <= 0) {
                return currentPoll.optionB.name;
            } else if (state.fighterB.hp <= 0) {
                return currentPoll.optionA.name;
            }
            return null;
        });
    }, []);
    ...
    const networkPort = import.meta.env.VITE_PORT || '3000';
            ...
            <div className="w-80 h-full bg-[#0a0a0a] border-l-4 border-yellow-500 z-30 flex flex-col p-8 relative">
                ...
                <div className="flex-1 space-y-8 font-mono">
                    ...
                    <div className="bg-zinc-900/50 p-4 border-l-4 border-red-600">
                        ...
                        <div className="text-3xl font-black text-white">{remoteNodeCount}</div>
